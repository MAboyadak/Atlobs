...
@section('content')
    <div class="container card p-3 ps-4">
        ...
        <div class="d-flex flex-row-reverse flex-wrap align-items-center justify-content-between">

            <div class="d-flexjustify-content-end col-6 col-md-4">
                <div class="text-end">
            ...
            <div class="d-flex  justify-content-md-start justify-content-end  col-12 col-md-4">
                <div class="text-end">
        ...
        <br>
        <div class="d-flex flex-row-reverse flex-wrap align-items-center justify-content-start">
            <h6 class="mb-3  fw-bold m-0">نبذة عن المستخدم</h6>
            <p class="text-end lh-lg">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص
