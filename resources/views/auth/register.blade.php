        ...
        <section class=" py-5 forms ">
            <div class="container">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-4 col-md-8 card shadow">
                                ...
                                <div class="d-flex flex-column flex-md-column flex-lg-row ">
                                    ...
                                    <div class="col-12 col-md-12 mb-3 col-lg-6 input-box">
                                        ...
                                        <input type="password"id="password-confirm"
                                            class="form-control password id_password" name="password_confirmation" required
                                ...
                                <div class="d-flex">
                                    <div class="col-md-6">
                                        <input type="radio" name="type" value="0"
                                            class="me-3  form-check-input" id="info_type0">
                                        <label for="info_type0">أفراد
                                        </label>
                                    </div>
                                    <div class="col-md-8 mb-3">
                                        <input type="radio" name="type" value="1"
                                            class="me-3  form-check-input" id="info_type1">
