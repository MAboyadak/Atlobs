...
@section('content')
    <main class="container">
        <h1 class="text-end my-3" style="color: #160D60">الرسائل </h1>
        <section class="row">
            <div class="card col-8">
                ...
                <div class="card-body chat-history">
                    <ul id="myulForChat">
                        <li class=" d-flex justify-content-end">
                                ...
                                <span class="mychat-text text-light text-wrap text-end ">حمودي بسلسهليستخبايسخبياسخ يىبيسى خسهعبيسى سيعباب
                                    سينعب بشسشسيسبيس
                                </span>
                ...
                <div class="input-group mb-3">
                    <button class="btn btn-lg mx-3" style="background-color: #160D60;"><i style="color:white;"
